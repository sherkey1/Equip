...
public class DateChooser extends JTextField{
    ...
    //private JTextField this;//,toSelect;
    ...
    private void initTextField(){
        DateChooser.this.setText((sdf.format(initDate)));
        DateChooser.this.setEditable(false);
...
//        this.add(toSelect,BorderLayout.EAST);
        //this.setPreferredSize(new Dimension(98,22));
//        this.setBorder(BorderFactory.createLineBorder(Color.GRAY));
        this.addMouseListener(new MouseAdapter(){
            ...
            public void mousePressed(MouseEvent me){
                if(DateChooser.this.isEnabled()){
                    DateChooser.this.setForeground(Color.CYAN);
                    if(isShow){
                        hidePanel();
                    }else{
                        DateChooser.this.showPanel(DateChooser.this);
                    }
                }
            }
    ...
    private void commit(){
        ...
        this.setText(sdf.format(select.getTime()));
        hidePanel();
    }
